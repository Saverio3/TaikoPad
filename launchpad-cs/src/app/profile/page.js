    ...
    <div className="min-h-[1500px]">
      ...
      <div className="p-7 bg-[#1B1B1B] rounded-[16px]">
        <div className="flex flex-col gap-3 pb-8 border-b border-[#2C2C2C]">
          ...
          <p className="text-[16px] text-[#C03F4A]">0.639639 ETH</p>
        </div>
        <div className="flex flex-row gap-4 mt-7 max-sm:w-[100%]">
          <button className="py-3 px-5 rounded-lg bg-[#C03F4A] max-sm:w-[100%]">
            Share your profile
          </button>
          ...
          <div className="flex flex-row pb-5 border-b border-[#2C2C2C] gap-8 max-sm:w-[1500px]">
            {tabItems.map((item, index) => (
              ...
              >
                <p
                  className={`text-base ${
                    tabActive === index ? "text-[#C03F4A]" : "text-white"
                  }`}
                >
                  {item.name}
                </p>
                {tabActive === index && (
                  <hr className="h-0.5 border-0 bg-[#C03F4A] w-[100%] absolute -bottom-[21px] left-0"></hr>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="mt-8">
          ...
          {tabActive === 2 && (
            <div className="flex flex-row items-center justify-between">
              ...
              <p className="text-base text-[#C03F4A] cursor-pointer">View</p>
            </div>
          )}
          {tabActive === 3 && (
            <div className="">
              <div className="flex flex-col gap-4">
                {Array.from({ length: 7 }).map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-base text-[#C03F4A] cursor-pointer">
                      View
                    </p>
                  </div>
                ))}
              ...
              <div className="mt-[30px] flex flex-row gap-[11.2px] justify-end max-sm:hidden">
                ...
                <div className="w-[28px] h-[28px] bg-[#C03F4A] rounded-[5.6px] flex flex-row justify-center items-center">
      ...
      {/* {(tabActive === 0 || tabActive === 1) && (
        <div className="mt-[157px] max-sm:mt-8 pb-5 flex flex-row justify-center">
          <p className="text-center text-lg max-sm:text-sm text-white w-[1155px]">
            ...
            <span className="text-[#C03F4A]">Binance Academy</span>.
          </p>
        </div>
      )} */}
