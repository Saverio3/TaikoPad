    ...
    <div className="min-h-[1500px]">
      ...
      <div className="bg-[#1B1B1B] rounded-2xl p-5 flex-col gap-[50px] max-sm:flex hidden mt-8 lg:mt-0">
        <div className="sm:flex grid flex-row gap-4">
          ...
          <div className="flexflex-col pl-2">
        ...
        {step === 1 && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-row justify-end">
              <button
                className="bg-[#FA8B84] rounded-[10px] max-sm:w-[100%] py-[10px] px-[61px] text-sm font-semibold text-[#151103]"
                onClick={() => setStep(2)}
              >
                Next
              </button>
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="flex flex-row gap-6 max-sm:flex-col">
              <div className="flex flex-col w-[100%] gap-3">
                <p className="text-sm text-[#C03F4A]">Banner (Not requared)</p>
