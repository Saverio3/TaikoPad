...
import { ConnectBtn } from "../../Button/ConnectBtn";
...
const Header = ({ show, setShow }) => {
  ...
  return (
    <>
      <div className="relative lg:w-[calc(100vw-286px)] h-20 px-10 bg-[#1b1b1b]/[.99] ml-[-1px] flex items-center justify-between max-md:hidden">
        <div className="flex gap-2">
          ...
          <Link
            ...
            target="_blank"
          >
            <IconBtn text="Docs" disable="home" icon={Docs} heigh="h-[37px]" />
          </Link>
          <Link href={"https://t.me/flashlaunchalert"} target="_blank">
            <IconBtn text="presale alerts" disable="home" icon={Alert} heigh="h-[37px]" />
          </Link>
          ...
          <div className="2xl:ml-[33px] ml-[10px]">
            <IconBtn
        ...
        <div className="flex gap-x-[15.05px]">
          <div className="relative">
            <div onClick={() => setLanShow(!lanShow)} className="border border-[#2C2C2C] rounded-[33px] py-[5px] px-[15px] w-[80px] xxl:w-[110px] h-[34px] flex flex-row gap-[10px] items-center cursor-pointer">
              <ExportedImage src={UKIcon} alt="icon" />
              <p className="text-white text-sm xl:block hidden">UK</p>
              <div className="flex flex-row justify-center items-center w-[24px] h-[24px]">
                <ExportedImage src={UpIcon} alt="icon" />
              </div>
            </div>
              {lanShow && (
                <div className="bg-[#1B1B1B] flex flex-col rounded-lg absolute top-[40px] z-50 pb-2">
                  {lanList.map((item, index) => (
                    <div
                      key={index}
                      className="flex flex-row py-2 border-b border-white gap-3 cursor-pointer absolute ml-3 pl-1 pr-6"
      ...
      <div className="md:hidden flex flex-row p-5 justify-between">
